    ...
    <footer className="relative w-full bg-[#333333] py-16 font-['Poppins'] text-white">
      <div className={`mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 ${gridColsClass}`}>
        ...
        {hasCta && (
          <div>
            <h2
              className="font-['Poppins'] text-2xl leading-tight font-bold sm:text-3xl md:text-4xl"
              data-tina-field={tinaField(ftr, 'ctaHeadline')}
            >
              {ftr?.ctaHeadline}
            </h2>
            <p
              className="mt-6 max-w-full font-['Poppins'] text-sm font-normal sm:text-base"
                ...
                if (subLinks.length === 0) {
                  return (
                    <Link
                      ...
                      className={`font-['Poppins'] text-sm hover:underline sm:text-base ${active ? 'font-semibold text-[#00FCE2] underline' : 'font-normal'}`}
                    ...
                    >
                      {subLinks.map((sub: any, j: number) => (
                        <Link
                          ...
                          className={`font-['Poppins'] text-sm hover:underline sm:text-base ${isActive(sub?.href) ? 'font-semibold text-[#00FCE2]' : 'font-normal text-white/70 hover:text-white'}`}
        ...
        <div>
          {ftr?.offices?.map((office: any, i: number) => (
            <div key={i} className={i > 0 ? 'mt-8' : ''}>
              ...
              <h3
                className="font-['Poppins'] text-base font-normal sm:text-lg"
                data-tina-field={tinaField(office, 'city')}
              >
                {office.city}
              </h3>
              <p
                className="mt-4 max-w-full font-['Poppins'] text-sm font-normal sm:text-base"
