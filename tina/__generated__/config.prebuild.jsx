...
function seoFields() {
  return {
    ...
    fields: [
      ...
      { type: "image", name: "ogImage", label: "OG / Social Share Image (1200\xD7630px recommended)" },
      {
        type: "string",
        name: "canonicalUrl",
        label: "Canonical URL",
      ...
      // ── GLOBAL SITE SETTINGS ─────────────────────────────────────────
      {
        ...
        fields: [
          ...
          },
          {
            type: "object",
            name: "analytics",
            label: "\u{1F4CA} Analytics & Search Console",
            fields: [
              {
                type: "string",
                name: "ga4Id",
          ...
          },
          {
            type: "object",
            name: "globalSeo",
            label: "\u{1F310} Global SEO Defaults",
      ...
      // ── BLOG POSTS ──────────────────────────────────────────────────
      {
        ...
        fields: [
          ...
          seoFields(),
          {
            type: "object",
            name: "faqs",
            label: "\u2753 FAQs (for FAQ schema \u2014 boosts SEO)",
            list: true,
