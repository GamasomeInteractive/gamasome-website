...
_Three collection methods, one training-ready dataset — the mix depends on the task, not a fixed rulebook._
...
_Complex multi-sensor humanoid programs run roughly 4–5x the cost per hour of simple constrained tasks._
...
_Every deployed episode is a data point — the strongest programs treat collection as a loop, not a one-time delivery._
