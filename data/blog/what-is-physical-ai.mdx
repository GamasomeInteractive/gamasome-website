...
A world foundation model is an AI model that has learned the physics of the real world well enough to generate realistic, physics-accurate synthetic data, like video of how objects move and collide. It lets developers train robots without collecting every example from real hardware. [NVIDIA's Cosmos](https://www.nvidia.com/en-us/ai/cosmos/) is the best-known example.
