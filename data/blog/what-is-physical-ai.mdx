...
images: ['/static/images/physical-ai-guide.jpg']
faqs:
...
2. **Reason.** AI models interpret that data, build an understanding of the space, and decide on a plan. Newer systems split this into a fast, reflexive layer for immediate reactions and a slower, deliberate layer for planning — an approach NVIDIA describes as a dual-system architecture.
