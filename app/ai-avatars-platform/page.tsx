...
export default function AiAvatarsPlatform() {
  const pageTitle = `${siteMetadata.title} - AI Digital Avatars & Conversational Platforms`
  const pageDescription =
    'Create photorealistic digital avatars with AI-powered behavior, real-time lip sync, and natural conversation capabilities for immersive experiences.'
      ...
      <div className="relative w-full bg-white font-['Poppins']">
        ...
        <section id="home" className="relative h-screen w-full bg-[#07091B]">
          ...
          <div className="absolute inset-0 z-10">
            <Image
              src="/static/images/avatar-banner.jpg"
              alt="AI Avatars & Conversational Platform Banner"
              fill
          ...
          >
            <h1 className="font-['Poppins'] text-4xl leading-tight font-semibold text-white sm:text-5xl md:text-7xl">
              Create Intelligent Digital Avatars & Conversational Experiences
            </h1>
            <p className="mt-4 font-['Poppins'] text-xl font-normal tracking-[-0.025em] text-white sm:text-2xl md:text-3xl">
              Photorealistic avatars with personalized behavior and lifelike interaction
            </p>
            <SlideFromBottom delay={0.4} distance={40}>
              <Link
                href="#avatar-services"
        ...
        {/* Avatar Services Section */}
        <section id="avatar-services" className="relative w-full bg-white py-16">
          <div className="container mx-auto px-4">
            <FadeIn>
              <h2 className="mb-12 text-center font-['Poppins'] text-3xl leading-tight font-semibold text-gray-900 sm:text-4xl md:text-5xl">
                AI Avatar & Conversational Solutions
              </h2>
            </FadeIn>
            <div className="mx-auto flex max-w-7xl flex-col gap-8">
              {[
                {
                  title: 'Photorealistic Digital Avatars',
                  description:
                    'Create stunning photorealistic digital avatars for customer engagement, virtual assistants, and immersive experiences. Using advanced 3D modeling, MetaHuman technology, and AI-driven animation, we bring digital personas to life with unprecedented realism. Perfect for brands looking to create memorable digital representatives.',
                  imgSrc: '/static/images/avatar-photorealistic.jpg',
                  bg: '#FFFCFA',
                  direction: 'left' as const,
                },
                {
                  title: 'Personalized Avatar Behavior & Animation',
                  description:
                    'Develop custom personality traits and behavioral patterns for your digital avatars. Our AI systems enable avatars to exhibit unique mannerisms, gestures, and communication styles that align with your brand identity or character design. Each avatar can have distinct emotional expressions and interaction patterns.',
                  imgSrc: '/static/images/avatar-behavior.jpg',
                  bg: '#F5FEFF',
                  direction: 'right' as const,
                },
                {
                  title: 'Realistic Lip Sync & Voice Integration',
                  description:
                    'Implement advanced lip-sync technology that synchronizes avatar speech with natural mouth movements in real-time. Our solutions support multiple languages and integrate seamlessly with text-to-speech engines and voice recognition systems, creating fluid and believable conversational experiences.',
                  imgSrc: '/static/images/avatar-lipsync.jpg',
                  bg: '#FFFCFA',
                  direction: 'left' as const,
                },
                {
                  title: 'Conversational AI & NLP Integration',
                  description:
                    'Build intelligent conversational systems powered by natural language processing. We integrate large language models, intent recognition, and contextual understanding to create avatars that can engage in meaningful, context-aware conversations. Ideal for customer service, education, and entertainment applications.',
                  imgSrc: '/static/images/avatar-conversational.jpg',
                  bg: '#F5FEFF',
                  direction: 'right' as const,
                },
              ].map((service) =>
              ...
              {[
                {
                  ...
                  description: 'Dedicated teams on a monthly retainer for ongoing avatar projects.',
                  icon: (
                    <svg
        ...
        <section id="technologies" className="relative w-full bg-[#2D9CDB] py-16">
          ...
          <SlideFromBottom className="mx-auto mt-12 max-w-[875px] rounded-lg border border-[#00FCE2] bg-[#2D9CDB] p-6 text-center">
            <h3 className="font-['Poppins'] text-xl font-bold text-white sm:text-2xl">
              Ready to Create Intelligent Digital Avatars?
            </h3>
            <p className="mt-2 font-['Poppins'] text-base font-normal text-white/60">
              Let us help you build photorealistic, AI-powered conversational experiences.
            </p>
            <Link
              href="/contact"
