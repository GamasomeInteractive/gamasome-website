...
export default function ThemePickerPage() {
  ...
  return (
    ...
    >
          ...
          return (
            ...
            >
              ...
              <div style={{ display: 'flex', height: 8 }}>
                {[c.bgPrimary, c.primaryColor, c.accentColor, c.labelColor, c.bgFooter].map(
                  (clr, i) => (
              ...
              >
                ...
                <div
                  style={{
                    position: 'absolute',
                    inset: 0,
                    background: `radial-gradient(ellipse 80% 60% at 80% 40%, ${c.primaryColor}20, transparent 65%)`,
                  }}
                />
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                  ...
                  <div
                    style={{
                      ...
                      lineHeight: 1,
                      background: `linear-gradient(to right, ${c.primaryColor}, ${c.accentColor})`,
      ...
      >
        Applying a theme updates the Typography colors in the TinaCMS AI Platform collection. You
        can still fine-tune individual colors via the CMS sidebar after applying.
      </div>
    </div>
  )
}
